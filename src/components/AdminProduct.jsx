...
function AdminProduct({ info, meta }) {
    ...
    <>
      ...
      <section className="py-6 w-[82%] h-screen">
        <div className="flex justify-between items-end mb-8">
          <div>
            <p className="mb-5 text-color-2 text-2xl font-medium">Product List</p>
            <div className="flex gap-[10px] bg-color-1 hover:bg-color-1-hover cursor-pointer p-3 rounded-md" onClick={addProductModalHandler}>
              ...
              <p className="text-color-2 text-sm font-medium">Add Product</p>
            </div>
          </div>
          <div>
            <p className="mb-2 text-[#4f5665] text-xs font-medium">Search Product</p>
            <div className="flex gap-[10px]">
              <div className="flex gap-[10px]">
                <input type="text" name="" id="" placeholder="Enter Product Name" className="p-[10px] border border-[#e8e8e8] rounded-l-md border-r-0" />
        ...
        <section className="py-7 px-3 border border-[#e8e8e8] rounded-md">
          <div className="grid grid-cols-9 items-center py-3 border-b border-[#e8e8e8]/[.30]">
            ...
            <p className="text-center text-[#4f5665] text-xs font-semibold">Image</p>
            <p className="text-center text-[#4f5665] text-xs font-semibold">Product Name</p>
            <p className="text-center text-[#4f5665] text-xs font-semibold">Price</p>
            <p className="text-center text-[#4f5665] text-xs font-semibold">Desc</p>
            <p className="text-center text-[#4f5665] text-xs font-semibold">Product Size</p>
            <p className="text-center text-[#4f5665] text-xs font-semibold">Method</p>
            <p className="text-center text-[#4f5665] text-xs font-semibold">Stock</p>
            <p className="text-center text-[#4f5665] text-xs font-semibold">Action</p>
          </div>
          {info ? info.map((product, idx) => <ProductList key={idx} data={product} card={idx}></ProductList>) : <p className="text-2xl text-center">Product Not Found</p>}
          <section className="flex justify-between mt-[19px] items-center">
            <p className="text-[#4f5665] text-xs font-medium">{`Show 6 Products of ${meta} product`}</p>
